...
class Adafruit_SPITFT : public Adafruit_GFX {
  ...
  public:
    ...
    */
    ...
    uint8_t      spiRead();             // Read single byte of data
  ...
  protected:
    ...
    inline void  SPI_MOSI_HIGH();
    inline void  SPI_MOSI_LOW();
    inline void  SPI_SCK_HIGH();
    inline void  SPI_SCK_LOW();
    inline bool  SPI_MISO_READ();
    inline void  SPI_BEGIN_TRANSACTION();
    inline void  SPI_END_TRANSACTION();
    inline void  TFT_WR_STROBE(); // Parallel interface write strobe
    inline void  TFT_RD_HIGH();   // Parallel interface read high
    inline void  TFT_RD_LOW();    // Parallel interface read low
