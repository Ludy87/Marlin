...
*/
inline void Adafruit_SPITFT::SPI_BEGIN_TRANSACTION() {
    if(connection == TFT_HARD_SPI) {
#if defined(SPI_HAS_TRANSACTION)
...
*/
inline void Adafruit_SPITFT::SPI_END_TRANSACTION() {
#if defined(SPI_HAS_TRANSACTION)
    if(connection == TFT_HARD_SPI) {
...
*/
inline void Adafruit_SPITFT::SPI_MOSI_HIGH() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
  #if defined(KINETISK)
    *swspi.mosiPortSet = 1;
...
*/
inline void Adafruit_SPITFT::SPI_MOSI_LOW() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
  #if defined(KINETISK)
    *swspi.mosiPortClr = 1;
...
*/
inline void Adafruit_SPITFT::SPI_SCK_HIGH() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
  #if defined(KINETISK)
    *swspi.sckPortSet = 1;
...
*/
inline void Adafruit_SPITFT::SPI_SCK_LOW() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
  #if defined(KINETISK)
    *swspi.sckPortClr = 1;
...
*/
inline bool Adafruit_SPITFT::SPI_MISO_READ() {
#if defined(USE_FAST_PINIO)
 #if defined(KINETISK)
...
*/
inline void Adafruit_SPITFT::TFT_WR_STROBE() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
  #if defined(KINETISK)
    *tft8.wrPortClr = 1;
...
/*!
    @brief  Set the RD line HIGH. Used for parallel-connected interfaces
            when reading data.
*/
inline void Adafruit_SPITFT::TFT_RD_HIGH() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
...
/*!
    @brief  Set the RD line LOW. Used for parallel-connected interfaces
            when reading data.
*/
inline void Adafruit_SPITFT::TFT_RD_LOW() {
#if defined(USE_FAST_PINIO)
 #if defined(HAS_PORT_SET_CLR)
