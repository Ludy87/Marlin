...
#define STATUS_HEATER_BMP_X(I)  (POS_8) * I - ((POS_8) + (HEATER_BMP_WIDTH)) / 2
...
#define STATUS_BED_BMP_X      (LCD_PIXEL_WIDTH) - (POS_8) - ((POS_8) + (BED_BMP_WIDTH)) / 2
#define STATUS_BED_TEXT_X     (STATUS_BED_BMP_X) + (FONT_WIDTH)

#define STATUS_FAN_BMP_X(I)   (POS_8) * (I) - ((POS_8) + (FAN_BMP_WIDTH)) / 2
