...
#endif
{
  public:
    ...
    void init(bool initial, bool pulldown_rst_mode = false)
    {
      epd2.init(initial, pulldown_rst_mode);
      _using_partial_mode = false;
      _current_page = 0;
      setFullWindow();
    }
  ...
  private:
    ...
    int16_t _pages, _page_height;
    int16_t _pw_x, _pw_y, _pw_w, _pw_h;
};
