...
#if defined(SW_EPAPER_SCK) && SW_EPAPER_SCK >= 0
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_SCK)
#endif
#if defined(SW_EPAPER_MOSI) && SW_EPAPER_MOSI >= 0
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_MOSI)
#endif
#if PIN_EXISTS(SW_EPAPER_CS)
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_CS_PIN)
#endif
#if PIN_EXISTS(SW_EPAPER_DC)
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_DC_PIN)
#endif
#if PIN_EXISTS(SW_EPAPER_RST)
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_RST_PIN)
#endif
#if PIN_EXISTS(SW_EPAPER_BUSY)
  REPORT_NAME_DIGITAL(__LINE__, SW_EPAPER_BUSY_PIN)
#endif
